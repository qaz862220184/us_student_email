...
IFontDisp = Font
__all__ = [ 'OLE_YPOS_PIXELS', 'Picture', 'Default', 'Color',
           'Checked', 'OLE_YPOS_HIMETRIC', 'FontEvents', 'IPicture',
           'OLE_TRISTATE', 'IFont', 'Font', 'StdPicture', 'StdFont',
           'OLE_XPOS_HIMETRIC', 'IPictureDisp', 'FONTBOLD',
           'OLE_YPOS_CONTAINER', 'FONTSTRIKETHROUGH',
           'LoadPictureConstants', 'OLE_OPTEXCLUSIVE',
           'OLE_YSIZE_PIXELS', 'OLE_HANDLE', 'IFontEventsDisp',
           'OLE_COLOR', 'OLE_XSIZE_CONTAINER', 'FONTSIZE',
           'OLE_XPOS_CONTAINER', 'OLE_XPOS_PIXELS',
           'OLE_YSIZE_HIMETRIC', 'VgaColor', 'Unchecked',
           'OLE_CANCELBOOL', 'IFontDisp', 'OLE_XSIZE_HIMETRIC',
           'Monochrome', 'FONTITALIC', 'OLE_YSIZE_CONTAINER',
           'FONTUNDERSCORE', 'Gray', 'OLE_ENABLEDEFAULTBOOL',
           'FONTNAME', 'OLE_XSIZE_PIXELS']
